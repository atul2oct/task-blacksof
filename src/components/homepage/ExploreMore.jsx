...
const ExploreMore = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <div className='flex flex-row gap-6 items-center bg-gradient-to-b from-white to-[#E1F4FF]'>
                <img src={require(`../../assests/Images/${currentCard.image}.png`)} alt={currentCard.heading} className='aspect-square w-1/2 object-cover' />
